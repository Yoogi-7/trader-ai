# apps/api/config.py
# PL: Konfiguracja aplikacji z env. EN: App config via env.
...
class Settings(BaseModel):
    ...
    database_url: str = Field(default=os.getenv("DATABASE_URL", "postgresql+psycopg2://postgres:postgres@localhost:5432/postgres"))
